...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // medicina_inasistencias_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'medicina_inasistencias_homepage')), array (  '_controller' => 'Medicina\\InasistenciasBundle\\Controller\\DefaultController::indexAction',));
        }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/medicina/inasistencias/employee')) {
                // admin_medicina_inasistencias_employee_list
                if ($pathinfo === '/admin/medicina/inasistencias/employee/list') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'sonata.admin.post',  '_sonata_name' => 'admin_medicina_inasistencias_employee_list',  '_route' => 'admin_medicina_inasistencias_employee_list',);
                }

                // admin_medicina_inasistencias_employee_create
                if ($pathinfo === '/admin/medicina/inasistencias/employee/create') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'sonata.admin.post',  '_sonata_name' => 'admin_medicina_inasistencias_employee_create',  '_route' => 'admin_medicina_inasistencias_employee_create',);
                }

                // admin_medicina_inasistencias_employee_batch
                if ($pathinfo === '/admin/medicina/inasistencias/employee/batch') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'sonata.admin.post',  '_sonata_name' => 'admin_medicina_inasistencias_employee_batch',  '_route' => 'admin_medicina_inasistencias_employee_batch',);
                }

                // admin_medicina_inasistencias_employee_edit
                if (preg_match('#^/admin/medicina/inasistencias/employee/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_medicina_inasistencias_employee_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'sonata.admin.post',  '_sonata_name' => 'admin_medicina_inasistencias_employee_edit',));
                }

                // admin_medicina_inasistencias_employee_delete
                if (preg_match('#^/admin/medicina/inasistencias/employee/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_medicina_inasistencias_employee_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'sonata.admin.post',  '_sonata_name' => 'admin_medicina_inasistencias_employee_delete',));
                }

                // admin_medicina_inasistencias_employee_show
                if (preg_match('#^/admin/medicina/inasistencias/employee/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_medicina_inasistencias_employee_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'sonata.admin.post',  '_sonata_name' => 'admin_medicina_inasistencias_employee_show',));
                }

                // admin_medicina_inasistencias_employee_export
                if ($pathinfo === '/admin/medicina/inasistencias/employee/export') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'sonata.admin.post',  '_sonata_name' => 'admin_medicina_inasistencias_employee_export',  '_route' => 'admin_medicina_inasistencias_employee_export',);
                }
